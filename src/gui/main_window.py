...
from PyQt6.QtCore import (
    QMetaObject, QSize, Qt, Q_ARG, QTimer, QUrl, QThread, QObject,
    pyqtSignal, pyqtSlot
)
...
from PyQt6.QtWidgets import (
    ...
    QSplitter, QStackedWidget, QMessageBox, QProgressBar, QFrame,
    QStatusBar
)
...
from src.unified_downloader import (
    ...
    DownloadProgress, VideoInfo, get_video_id, download_thumbnail
)
...
class DownloadWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # 初始化統一下載管理器
        from src.gui.unified_download_manager import UnifiedDownloadManager, DownloadStatus
        ...
        self.download_manager = UnifiedDownloadManager(download_path)
    ...
    def on_download_clicked(self):
        ...
        # 使用統一下載模組的函數檢測是否是播放清單URL
        from src.unified_downloader import is_playlist_url, clean_url
